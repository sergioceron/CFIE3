 ...
 * Time: 15:13
 */
public class Report3Bean {
	static final String MONTHS[] = {"Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"};
    static final String C1 = "Medio Superior";
    static final String C2 = "Superior";
    static final String C3 = "Posgrado";
	...
	public void init(){
        ...
        for( Proyecto p : all ){
            ...
            if( p.getNivelAcademico().equals(C1) ){
            ...
            if( p.getNivelAcademico().equals(C2) ){
            ...
            if( p.getNivelAcademico().equals(C3) ){
	...
	public PieChartModel getProyectosByNivel(){
		PieChartModel pieModel = new PieChartModel();
		Map<String, Number> values = new HashMap<String, Number>();
		for( Proyecto p : actual ){
			String criterio = p.getNivelAcademico();
	...
	public CartesianChartModel getAllProyectosByNivel(){
		return model;
	}
